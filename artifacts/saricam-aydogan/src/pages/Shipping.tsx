            ...
            {[
              {
                step: "01",
                title: "Sipariş",
                desc: "WhatsApp'tan ürünü iletin veya mağazamıza uğrayın. Stok ve fiyat teyidini hemen veriyoruz.",
              },
              {
                step: "02",
                title: "Ödeme",
                desc: "Havale/EFT, kredi kartı veya kapıda ödeme — size en uygun seçeneği birlikte belirliyoruz.",
              },
              {
                step: "03",
                title: "Hazırlık",
                desc: "Ödeme onaylandıktan sonra ürün özenle paketlenir ve aynı gün kargoya verilir.",
              },
              {
                step: "04",
                title: "Teslimat",
                desc: "Anlaşmalı kargo firmamız ile 1–3 iş günü içinde adresinize ulaşır. Takip numarası size iletilir.",
              },
            ].map((s, idx) => (
              <motion.div
                key={s.step}
              ...
              >
                <span className="font-serif font-light text-5xl text-secondary leading-none">
                  {s.step}
                </span>
      ...
      <section className="section bg-muted/30">
        <div className="container px-6 max-w-6xl">
          ...
          <div className="border-t border-foreground/15">
            {[
              {
                area: "Adana Şehir İçi",
                time: "Aynı gün — 1 iş günü",
                note: "Mağazadan elden güvenilir alışveriş.",
              },
              {
                area: "Akdeniz Bölgesi & Komşu İller",
                time: "1 – 2 iş günü",
                note: "Anlaşmalı kargo firmaları ile hızlı teslimat.",
              },
              {
                area: "Türkiye Geneli",
                time: "1 – 3 iş günü",
                note: "Doğu illeri ve adalar için 1 iş günü ek süre olabilir.",
              },
            ].map((row) => (
              <div
                key={row.area}
              ...
              >
                <div className="flex items-baseline gap-3">
                  <MapPin
                    ...
                    strokeWidth={1.4}
                  />
                  <h3 className="font-serif font-light text-xl md:text-2xl text-foreground tracking-tight">
                    {row.area}
                  </h3>
                </div>
                <div className="font-serif italic font-light text-secondary text-lg md:text-xl">
                  {row.time}
                </div>
                <p className="text-foreground/60 text-sm leading-relaxed font-light">
                  {row.note}
          ...
          <p className="mt-10 text-foreground/55 text-xs md:text-sm uppercase tracking-[0.18em] text-center font-medium">
            Yoğun sezonlarda teslimat süreleri 1–2 gün uzayabilir · Kargolar
            hafta sonu çıkışı yapılmaz
          </p>
        </div>
      </section>
        ...
        <div className="container px-6 max-w-6xl">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20">
            <div className="border-t border-foreground/15 pt-8">
              <CreditCard
                className="w-6 h-6 text-secondary mb-6"
                strokeWidth={1.4}
              />
              ...
              <ul className="space-y-4 text-foreground/65 font-light leading-relaxed">
                <li className="flex gap-3">
                  <span className="text-secondary mt-2 w-1 h-1 rounded-full bg-current shrink-0" />
                  Mağazadan elden teslim alımda kargo{" "}
                ...
                <li className="flex gap-3">
                  <span className="text-secondary mt-2 w-1 h-1 rounded-full bg-current shrink-0" />
                  Standart kargo ücreti ürünün hacim ve ağırlığına göre değişir;
                  sipariş anında tarafınıza bildirilir.
                </li>
                <li className="flex gap-3">
                  <span className="text-secondary mt-2 w-1 h-1 rounded-full bg-current shrink-0" />
                  Çadır gibi büyük ebatlı ürünlerde özel kargo ücretlendirmesi
                  geçerlidir.
                </li>
                <li className="flex gap-3">
                  <span className="text-secondary mt-2 w-1 h-1 rounded-full bg-current shrink-0" />
                  Sipariş tutarınıza göre uygun kampanyaları sizinle
                  paylaşıyoruz.
                </li>
              </ul>
            </div>
            ...
            <div className="border-t border-foreground/15 pt-8">
              ...
              <ul className="space-y-4 text-foreground/65 font-light leading-relaxed">
                <li className="flex gap-3">
                  <span className="text-secondary mt-2 w-1 h-1 rounded-full bg-current shrink-0" />
                  Hassas elektronik ürünler köpük ve hava yastıklı zarflarla
                  korunur.
                </li>
                <li className="flex gap-3">
                  <span className="text-secondary mt-2 w-1 h-1 rounded-full bg-current shrink-0" />
                  Cam, ısıtıcı ve sıvı ürünler ekstra koruma sargısıyla
                  gönderilir.
                </li>
                <li className="flex gap-3">
                  <span className="text-secondary mt-2 w-1 h-1 rounded-full bg-current shrink-0" />
                  Olta kamışları kırılmaz tüpler içinde sevk edilir.
                </li>
                <li className="flex gap-3">
                  <span className="text-secondary mt-2 w-1 h-1 rounded-full bg-current shrink-0" />
                  Her sipariş kargoya verilmeden önce tarafımızca kontrol
                  edilir.
                </li>
              </ul>
            </div>
          ...
          <div className="mt-20 pt-10 border-t border-foreground/15">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-10">
              {[
                {
                  title: "Havale / EFT",
                  desc: "Sipariş onayı sonrası IBAN paylaşılır.",
                },
                {
                  title: "Kredi Kartı",
                  desc: "Mağazada veya güvenli ödeme linkiyle.",
                },
                {
                  title: "Kapıda Ödeme",
                  desc: "Belirli ürünlerde ve illerde mevcut.",
                },
                {
                  title: "Mağazadan Nakit",
                  desc: "Elden teslim alımda nakit kabul edilir.",
                },
              ].map((m) => (
                <div key={m.title}>
                  <h4 className="font-serif font-light text-xl mb-2 tracking-tight text-foreground">
                    {m.title}
                  </h4>
      ...
      <section className="section-sm bg-[#111111] text-white">
        <div className="container px-6 max-w-4xl text-center">
          ...
          <p className="text-white/55 text-base md:text-lg font-light mb-12 max-w-xl mx-auto leading-relaxed">
            WhatsApp'tan istediğiniz ürünü yazmanız yeterli. Stok teyidi, kargo
            ücreti ve teslimat süresini hemen bildirelim.
          </p>
          <a
