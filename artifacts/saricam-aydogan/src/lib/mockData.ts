...
export const mockProducts: Product[] = [
  ...
  },
  {
    ...
    price_label: '₺1.850', price_numeric: 1850,
    images: [asset('/mock/product-1.jpg')],
    featured: false, is_new: false, stock_status: 'in_stock',
  ...
  },
  {
    ...
    price_label: '₺2.900', price_numeric: 2900,
    images: [asset('/mock/category-cadir.jpg')],
    featured: false, is_new: true, stock_status: 'low_stock',
  ...
  },
  {
    ...
    price_label: '₺480', price_numeric: 480,
    images: [asset('/mock/product-1.jpg')],
    featured: false, is_new: false, stock_status: 'in_stock',
  ...
  /* ── c-2: Olta & Balık Malzemeleri ── */
  {
    ...
    price_label: '₺2.100', price_numeric: 2100,
    images: [asset('/mock/product-3.jpg')],
    featured: true, is_new: false, stock_status: 'in_stock',
  ...
  },
  {
    ...
    images: [asset('/mock/product-3.jpg')],
    featured: false, is_new: false, stock_status: 'low_stock',
  ...
  },
  {
    ...
    price_label: '₺1.750', price_numeric: 1750,
    images: [asset('/mock/category-olta.jpg')],
    featured: true, is_new: true, stock_status: 'in_stock',
  ...
  },
  {
    ...
    specs: { 'İğne Sayısı': '12 Adet', 'Tip': 'Hamsi Oltası', 'Misina': '0.40mm', 'Kurşun': '100gr' },
    price_label: '₺180', price_numeric: 180,
    images: [asset('/mock/product-3.jpg')],
    featured: false, is_new: false, stock_status: 'in_stock',
  ...
  /* ── c-3: Kamp Ekipmanları ── */
  {
    ...
    price_label: '₺380', price_numeric: 380,
  ...
  },
  {
    ...
    price_label: '₺650', price_numeric: 650,
  ...
  },
  {
    ...
    price_label: '₺1.450', price_numeric: 1450,
  ...
  },
  {
    ...
    specs: { 'Kapasite': '1.2 Litre', 'Malzeme': 'Sert Eloksallı Alüminyum', 'Ağırlık': '210 gr', 'Sap': 'Isıya Dayanıklı Silikon' },
    price_label: '₺420', price_numeric: 420,
    images: [asset('/mock/product-2.jpg')],
    featured: false, is_new: false, stock_status: 'in_stock',
  ...
  /* ── c-4: Aydınlatma ── */
  {
    ...
    price_label: '₺850', price_numeric: 850,
  ...
  },
  {
    ...
    price_label: '₺550', price_numeric: 550,
    images: [asset('/mock/category-aydinlatma.jpg')],
    featured: false, is_new: false, stock_status: 'in_stock',
  ...
  },
  {
    ...
    specs: { 'Güç': '20W', 'Çıkış': 'USB-A + USB-C', 'Ağırlık': '580 gr', 'Katlanmış Boyut': '28x16x2 cm' },
    price_label: '₺1.200', price_numeric: 1200,
    images: [asset('/mock/category-aydinlatma.jpg')],
    featured: false, is_new: true, stock_status: 'in_stock',
  ...
  /* ── c-5: Termos & Soğutucu ── */
  {
    ...
    price_label: '₺1.950', price_numeric: 1950,
  ...
  },
  {
    ...
    price_label: '₺680', price_numeric: 680,
    images: [asset('/mock/product-5.jpg')],
    featured: false, is_new: false, stock_status: 'in_stock',
  ...
  },
  {
    ...
    specs: { 'Kapasite': '12 Litre', 'Soğutucu Süre': '6 Saat', 'Malzeme': 'Isı Yalıtımlı Astar', 'Kapak': 'Su Geçirmez Fermuar' },
    price_label: '₺320', price_numeric: 320,
    images: [asset('/mock/product-5.jpg')],
    featured: false, is_new: false, stock_status: 'in_stock',
  ...
  /* ── c-6: Olta Aksesuarları ── */
  {
    ...
    price_label: '₺450', price_numeric: 450,
  ...
  },
  {
    ...
    specs: { 'İçerik': '10 Adet Taklit Yem', 'Boy': '4-6 cm', 'Tip': 'Parlak Metal Kaşık', 'Uygun Av': 'Hamsi, İstavrit' },
    price_label: '₺220', price_numeric: 220,
    images: [asset('/mock/product-4.jpg')],
    featured: false, is_new: false, stock_status: 'in_stock',
  ...
  },
  {
    ...
    specs: { 'Boy': '300 Metre', 'Çap Seçeneği': '0.25 / 0.30 / 0.35 / 0.40mm', 'Kırılma Gücü': '8-16 kg', 'Malzeme': 'Fluoro Carbon' },
    price_label: '₺180', price_numeric: 180,
    images: [asset('/mock/product-4.jpg')],
    featured: false, is_new: false, stock_status: 'in_stock',
  ...
  },
  {
    ...
    specs: { 'İçerik': '200 Adet', 'Beden': '2-12 Numara', 'Malzeme': 'Karbon Çelik + Nikel Kaplama', 'Tip': 'Halkalı ve Halkasız' },
    price_label: '₺135', price_numeric: 135,
    images: [asset('/mock/product-4.jpg')],
    featured: false, is_new: false, stock_status: 'in_stock',
  ...
  /* ── c-7: Outdoor & Trekking ── */
  {
    ...
    price_label: '₺750', price_numeric: 750,
    images: [asset('/mock/product-6.jpg')],
    featured: true, is_new: true, stock_status: 'in_stock',
  ...
  },
  {
    ...
    specs: { 'Fonksiyon': '18 Adet', 'Malzeme': '420 Paslanmaz Çelik', 'Ağırlık': '220 gr', 'Kılıf': 'Deri Kılıf Dahil' },
    price_label: '₺420', price_numeric: 420,
    images: [asset('/mock/product-6.jpg')],
    featured: false, is_new: false, stock_status: 'in_stock',
  ...
  },
  {
    ...
    price_label: '₺380', price_numeric: 380,
    images: [asset('/mock/product-6.jpg')],
    featured: false, is_new: false, stock_status: 'out_of_stock',
