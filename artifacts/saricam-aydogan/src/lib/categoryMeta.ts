...
export const categoryMetas: CategoryMeta[] = [
  {
    ...
    seoDescription: 'Karadeniz\'in zorlu iklim koşullarına uygun 4 mevsim kamp çadırları. 2 kişilik ve 3 kişilik opsiyonlar, yüksek su geçirmezlik değerleri. WhatsApp ile hızlı sipariş.',
  ...
  },
  {
    ...
    seoDescription: 'Levrek, lüfer ve hamsi avcıları için karbon olta kamışları, surf makineleri ve komple olta setleri. Karadeniz\'e uygun balık malzemeleri.',
    heroTitle: 'Olta & Balık Malzemeleri',
    heroSubtitle: 'Karadeniz avcıları için özenle seçilmiş olta ekipmanları',
    infoTitle: 'Karadeniz\'de Balık Avı İçin Doğru Olta Seçimi',
    infoText: 'Karadeniz kıyılarında surf, jigging ve pezgir tekniklerinin her birisi farklı kamış-makine kombinasyonları gerektirir. Kıyı surf avcılığı için 3-4 metre, 50-100 gram atarlı kamışlar tercih edilirken, jigging için 1.8-2.1 metre arası aksiyon kamışları kullanılır. Makine seçiminde tuzlu suya dayanıklı modeller ve güçlü kalama gücü önceliklidir. Yeni başlıyorsanız komple set seçenekleri hem ekonomik hem pratiktir. Hangi avı hedeflediğinizi söyleyin, en uygun kombinasyonu birlikte belirleyelim.',
  ...
  },
  {
    ...
    seoDescription: 'Sahte yem seti, balık iğnesi, fluoro carbon misina ve olta takımı aksesuarları. Karadeniz balıkçılığı için doğru yem ve iğne seçimi.',
    ...
    infoText: 'Olta aksesuarları av başarısını doğrudan etkileyen küçük ama kritik ekipmanlardır. Sahte yem seçiminde hedeflediğiniz balık türü belirleyicidir: levrek için 8-12cm jigging yemler, lüfer için metal kaşıklar, hamsi için parlak taklit yemler tercih edilir. Misina seçiminde ise fluoro carbon; görünmezliği ve aşınma direnciyle diğerlerine göre avantajlıdır. İğne kalitesi ise avın tamamlanmasında hayati rol oynar — paslanmaz veya nikel kaplı iğneler Karadeniz\'in tuzlu suyuna daha dayanıklıdır.',
...
export const allProductsMeta = {
  ...
  seoDescription: 'Kamp çadırı, olta kamışı, kamp feneri, termos ve outdoor ekipmanlarında geniş ürün yelpazesi. Karadeniz\'e uygun kaliteli malzemeler.',
  heroTitle: 'Tüm Ürünler',
  heroSubtitle: 'Kamp, balık ve outdoor malzemelerinde geniş ürün yelpazemiz',
  infoTitle: 'Sarıçam Aydoğan\'da Ne Bulabilirsiniz?',
  infoText: 'Trabzon\'un köklü kamp ve balık malzemeleri mağazası Sarıçam Aydoğan\'da kamp çadırı, uyku tulumu, kamp ekipmanları, olta kamışı, balık makinesi, kamp feneri, kafa lambası, termos ve soğutucu başta olmak üzere yüzlerce outdoor malzemesi bulabilirsiniz. Tüm ürünler Karadeniz\'in zorlu doğa koşullarında test edilmiş, güvenilir markaların ürünleridir. WhatsApp\'tan sipariş vermeniz yeterli.',
